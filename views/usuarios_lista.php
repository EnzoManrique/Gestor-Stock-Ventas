        ...
        <div class="col-md-4">
            <div class="card shadow mb-4">
                <div class="card-header <?php echo $usuario_editar ? 'bg-warning' : 'bg-dark'; ?> text-white">
                    <h5 class="mb-0">
                        <?php echo $usuario_editar ? '✏️ Editar Usuario' : '👤 Nuevo Usuario'; ?>
                    </h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="usuarios.php">
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn <?php echo $usuario_editar ? 'btn-warning' : 'btn-dark'; ?>">
                    ...
                    <table class="table table-hover">
                        ...
                        <?php foreach($lista_usuarios as $u): ?>
                            <tr class="<?php echo $u['activo'] == 0 ? 'table-secondary text-muted' : ''; ?>">
                                ...
                                <td>
                                    <a href="usuarios.php?editar=<?php echo $u['id_usuario']; ?>" class="btn btn-sm btn-warning">✏️</a>

                                    <?php if($u['activo']): ?>
                                        <?php if($u['id_usuario'] != $_SESSION['usuario_id']): ?>
                                            <a href="usuarios.php?eliminar=<?php echo $u['id_usuario']; ?>"
                                               class="btn btn-sm btn-danger"
                                               onclick="return confirm('¿Bloquear acceso a este usuario?')">🚫</a>
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <a href="usuarios.php?activar=<?php echo $u['id_usuario']; ?>"
                                           class="btn btn-sm btn-success" title="Reactivar">✅</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
