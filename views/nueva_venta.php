            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="" id="formVenta">
                            ...
                            <select name="cliente" class="form-select select2-simple" required>
                                ...
                                <?php foreach($lista_clientes as $c): ?>
                                    <option value="<?php echo $c['id_cliente']; ?>">
                                        <?php echo $c['nombre'] . ' ' . $c['apellido']; ?> (<?php echo $c['dni_cuil']; ?>)
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <button type="submit" class="btn btn-success w-100 btn-lg mt-2" onclick="return validarCarrito()">
                            ✅ Finalizar Venta
                        </button>
                    </form>
        ...
        carrito.forEach((item, index) => {
            ...
            const fila = `
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-sm btn-danger" onclick="eliminarDelCarrito(${index})">❌</button>
                    </td>
                </tr>
            `;
