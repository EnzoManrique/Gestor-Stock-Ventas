...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><i class="bi bi-rocket-takeoff"></i> Sistema Ventas</a>
    ...
    <div class="container mt-4">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <div
                    class="card text-white <?php echo ($alerta_stock > 0) ? 'bg-danger' : 'bg-primary'; ?> mb-3 shadow">
                    <div class="card-header">Estado de Stock</div>
                    <div class="card-body">
                        <?php if ($alerta_stock > 0): ?>
                            <h2 class="card-title"><i class="bi bi-exclamation-triangle-fill"></i>
                                <?php echo $alerta_stock; ?> Productos</h2>
                            <p class="card-text">Con stock bajo (menos de 5).</p>
                        <?php else: ?>
                            <h2 class="card-title"><i class="bi bi-check-circle-fill"></i> Todo OK</h2>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card text-center mb-3 h-100 shadow-sm hover-card">
                    <div class="card-body d-flex flex-column justify-content-center">
                        <h5 class="card-title"><i class="bi bi-cart-plus"></i> Nueva Venta</h5>
            ...
            <div class="col-md-4">
                <div class="card text-center mb-3 h-100 shadow-sm">
                    <div class="card-body d-flex flex-column justify-content-center">
                        <h5 class="card-title"><i class="bi bi-bar-chart-fill"></i> Reportes</h5>
            ...
            <div class="col-md-4">
                <div class="card text-center mb-3 h-100 shadow-sm border-info">
                    <div class="card-body d-flex flex-column justify-content-center">
                        <h5 class="card-title"><i class="bi bi-person-circle"></i> Clientes</h5>
                        <p class="card-text text-muted">Alta y modificación de clientes.</p>
                        <a href="controllers/clientes.php" class="btn btn-info text-white mt-auto">Gestionar
                            Clientes</a>
                    </div>
                </div>
            </div>
            ...
            <?php if ($_SESSION['rol'] == 1): ?>
                <div class="col-md-4">
                    <div class="card text-center mb-3 h-100 shadow-sm border-danger">
                        <div class="card-body d-flex flex-column justify-content-center">
                            <h5 class="card-title"><i class="bi bi-graph-up-arrow"></i> Estadísticas</h5>
